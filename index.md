...
<section class="content-band content-band--ink" id="examples">
  ...
  <div class="example-grid">
    <a class="example-card" href="{{ '/examples/repository-roles/copilot-instructions.html' | relative_url }}">
      <h3>Repository roles</h3>
      <p>Instructions for source authority, write ownership, and conflicts.</p>
    </a>
    <a class="example-card" href="{{ '/examples/repository-roles/workspace-layout.html' | relative_url }}">
      <h3>Workspace layout</h3>
      <p>A generic structure for personal notes, team repositories, and references.</p>
    </a>
    <a class="example-card" href="{{ '/examples/feedback-loop/checklist.html' | relative_url }}">
      <h3>Feedback loop</h3>
      <p>A practical loop from framing and evidence through validation and sharing.</p>
    </a>
    <a class="example-card" href="{{ '/examples/visual-template/today-ai-learned-weekly-template.svg' | relative_url }}">
